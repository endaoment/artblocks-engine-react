  ...
  return (
    ...
    >
      ...
      <div className="splashModuleColumn splashModuleColumnR">
        ...
        <p>
          Endaoment and Sostento are 501c3 charitable organizations. Proceeds
          will directly support programs that reduce burnout among frontline
  ...
  return (
    ...
    >
      <div className="splashModuleColumn splashModuleColumnL">
        ...
        <p>
          This generative art collection is a box of memories,a garden of
          hope,and a beacon of encouragement via ArtBlocks Engine platform.
        </p>
  ...
  return (
    ...
    >
      ...
      <div className="splashModuleColumn splashModuleColumnR">
        ...
        />
        <p>
          Raising funds to reduce burnout among hard working health workers
          through an NFT charity mining event &amp; auction.
        </p>
      ...
      <div id="splashModule1Banner">
        Art Blocks Mint + <span>&nbsp;Charity Fundraiser</span>
      </div>
    </div>
  );
}
